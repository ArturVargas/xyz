...
export default function BuildShipModal({ isOpen, onClose, onBuild, account }: BuildShipModalProps) {
    ...
    <div className="fixed inset-0 bg-gray-800/50 backdrop-blur-sm flex items-center justify-center z-50">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-lg relative">
        ...
        <div className="px-8 py-4 text-center">
          ...
          <p className="text-xl text-gray-500 mb-8">{account ? account.slice(0, 6) + "..." + account.slice(-4) : "0x..."}</p>
